...
\item [\refstepcounter{mnum} \mthemnum \label{mMM} \hypertarget{m1}:] Main Menu Module
\item [\refstepcounter{mnum} \mthemnum \label{mC} \hypertarget{m2}:] Character Module
\item [\refstepcounter{mnum} \mthemnum \label{mP} \hypertarget{m3}:] Player Module
\item [\refstepcounter{mnum} \mthemnum \label{mB} \hypertarget{m4}:] Board Module
\item [\refstepcounter{mnum} \mthemnum \label{mS} \hypertarget{m5}:] Score Module
\item [\refstepcounter{mnum} \mthemnum \label{mMV} \hypertarget{m6}:] Main Menu View Module
\item [\refstepcounter{mnum} \mthemnum \label{mBV} \hypertarget{m7}:] Board View Module
\item [\refstepcounter{mnum} \mthemnum \label{mBC} \hypertarget{m8}:] Button Controller Module
\item [\refstepcounter{mnum} \mthemnum \label{mKC} \hypertarget{m9}:] Key Controller Module
\item [\refstepcounter{mnum} \mthemnum \label{mG} \hypertarget{m10}:] Enemy Module
\end{description}
...
%Slight Modification to Uses Hierarchy Diagram
\begin{figure}[H]
\centering
