...
\subsubsection{Main Menu Module (\mref{mMMM})}
...
\subsubsection{Character Module (\mref{mCM})}
...
\subsubsection{Player Module (\mref{mPM})}
...
\subsubsection{Score Module (\mref{mSM})}
...
\subsubsection{Main Menu View Module (\mref{mMMVM})}
...
\subsubsection{Board View Module (\mref{mBVM})}
...
\subsubsection{Button Controller Module (\mref{mBCM})}
...
\subsubsection{Key Controller Module (\mref{mKCM})}
...
\subsubsection{Ghost Module (\mref{mGM})}
