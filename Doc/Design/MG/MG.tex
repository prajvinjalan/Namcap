...
\item[Services:]Implements an simple AI that moves the ghost on a valid path.
\item[Implemented By:] Namcap
\end{description}
...
NF5 & \mref{mC}, \mref{mP}, \mref{mB}, \mref{mS}, \mref{mBV}, \mref{mKC}\\%Big Dot functionality required
NF6 & \mref{mBH}, \mref{mSD}\\
NF7 & \mref{mC}, \mref{mP}, \mref{mB}, \mref{mBV}, \mref{mKC}\\%Big Dot functionality required
\bottomrule
\end{tabular}
