...
%Provided reference to the Gantt Project for detailed description of the project scheduling constraints and added link to Namcap Gantt Project.
...
%Big Dot active collision functionality has been addressed and the appropriate requirements have been added (US 10)
\begin{itemize}
\item
Use Case Number: 1
