...
2016-10-31 & 2.2 & Revision of System and Unit tests\\
\bottomrule
\end{tabularx}
\end{table}
...
How test will be performed: A JUnit method will test the Score class's addScore method to ensure that score can be appropriately added; the Player's checkDot method will be tested to see whether the game ends depending on the score
